...
const englishMessages = {
  ...
  "setup.keyboardHintTec": "Technical: up and down helium, [ and ] breathing rate, comma and period tank size, Tab switches cylinder, plus and minus add or remove one, g and G gradient factor low, f and F gradient factor high.",
...
const catalog: Record<SupportedLocale, Record<MessageKey, string>> = {
  ...
  de: {
    ...
    "setup.keyboardHintTec": "Technisch: Hoch und Runter Helium, [ und ] Atemminutenvolumen, Komma und Punkt Flaschengröße, Tab wechselt die Flasche, Plus und Minus fügen eine hinzu oder entfernen sie, g und G Gradient Factor Low, f und F Gradient Factor High.",
