...
const englishMessages = {
  ...
  "wreck.controls.hint": "Arrow keys or W A S D move the diver. T toggles the torch. F fast-forwards while you hold a stop.",
  "wreck.symbol.torch": "◉",
...
const catalog: Record<SupportedLocale, Record<MessageKey, string>> = {
  ...
  de: {
    ...
    "wreck.controls.hint": "Pfeiltasten oder W A S D bewegen die Figur. T schaltet die Lampe um. F spult vor, solange du einen Stopp hältst.",
    "wreck.symbol.torch": "◉",
    "wreck.symbol.fastForward": "»",
    "wreck.symbol.audio": "♪",
    "wreck.symbol.warning": "⚠",
