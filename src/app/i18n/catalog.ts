...
const englishMessages = {
  ...
  "wreck.controls.hint": "Arrow keys or W A S D move the diver. T toggles the torch. F fast-forwards while you hold a stop. On a rebreather, [ and ] move the setpoint and B bails out.",
  "wreck.symbol.torch": "◉",
...
const catalog: Record<SupportedLocale, Record<MessageKey, string>> = {
  ...
  de: {
    ...
    "wreck.controls.hint": "Pfeiltasten oder W A S D bewegen die Figur. T schaltet die Lampe um. F spult vor, solange du einen Stopp hältst. Am Kreislaufgerät ändern [ und ] den Setpoint, B löst den Bailout aus.",
    "wreck.symbol.torch": "◉",
    "wreck.symbol.fastForward": "»",
    "wreck.symbol.audio": "♪",
    "wreck.symbol.warning": "⚠",
